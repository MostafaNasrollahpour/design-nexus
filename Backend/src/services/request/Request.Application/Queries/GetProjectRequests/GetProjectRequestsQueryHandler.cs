...
namespace Request.Application.Queries.GetProjectRequests
{
    public class GetProjectRequestsQueryHandler : IRequestHandler<GetProjectRequestsQuery, BaseResponseDto>
    {
        private readonly IProjectRequestRepository _projectRequestRepository;
        private readonly IUserServiceClient _userServiceClient;
        private readonly ICurrentUser _currentUser;

        public GetProjectRequestsQueryHandler(IProjectRequestRepository projectRequestRepository, IUserServiceClient userServiceClient, ICurrentUser currentUser)
        {
        ...
        public async Task<BaseResponseDto> Handle(GetProjectRequestsQuery request, CancellationToken cancellationToken)
        {
            try
            {
