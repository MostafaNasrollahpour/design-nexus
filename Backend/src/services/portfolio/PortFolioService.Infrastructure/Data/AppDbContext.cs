...
public class AppDbContext : DbContext
{
      ...
      public DbSet<DesignerProfile> DesignerProfiles { get; set; } = default!;
      ...
      protected override void OnModelCreating(ModelBuilder modelBuilder)
      {
            ...
            // DesignerProfile table
            modelBuilder.Entity<DesignerProfile>(entity =>
            {
            entity.ToTable("designerprofiles");

            // PK
            entity.HasKey(d => d.DesignerId);

            entity.Property(d => d.DesignerId)
                  .HasColumnName("designer_id");
            ...
            entity.Property(d => d.AvatarUrl)
                  .HasColumnName("avatar_url");

            entity.Property(d => d.AvatarSize)
